...
@section('content')
    <div class="page-header">
        ...
        <p class="page-subtitle">Tambah berita atau pengumuman baru</p>
    </div>
        ...
        <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 20px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="author" class="form-control" value="{{ old('author', 'Admin Sekolah') }}">
                    @error('author')
                        <div style="color: var(--danger); font-size: 12px; margin-top: 4px;">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <small style="color: var(--text-secondary); font-size: 12px;">Format: JPG, PNG, GIF (Max: 500KB) - Akan digunakan sebagai thumbnail saat share di sosial media</small>
